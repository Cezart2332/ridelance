...
- Name: onboarding.spec.ts >> pasul 1 pe micro-pași >> un singur ecran pe rând, iar contorul avansează
- Location: tests/responsive/onboarding.spec.ts:251:3
...
Locator: getByRole('heading', { name: 'Ai împlinit 21 de ani?' })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Ai împlinit 21 de ani?' })
