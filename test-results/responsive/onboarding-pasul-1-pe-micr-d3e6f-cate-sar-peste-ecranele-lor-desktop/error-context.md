...
- Name: onboarding.spec.ts >> pasul 1 pe micro-pași >> documentele deja încărcate sar peste ecranele lor
- Location: tests/responsive/onboarding.spec.ts:286:3
...
Locator: getByRole('heading', { name: 'Ai atestat de transport alternativ?' })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Ai atestat de transport alternativ?' })
...
- banner:
  - button "Înapoi"
  - paragraph: Pasul 6 din 6
  - paragraph: Vehicul, copie conformă & ecusoane
  - button "Meniul contului"
- navigation "Pașii înrolării":
  - img "RIDElance"
  - text: Onboarding PFA ridesharing
  - paragraph: Înscriere
  - paragraph: Pasul 6 din 6
  - paragraph: 0%
  - paragraph: Vehicul, copie conformă & ecusoane
  - paragraph: ~10 minute
  - progressbar "0 din 6 pași finalizați"
  - list:
    - listitem:
      - button "Eligibilitate — Blocat" [disabled]:
        - paragraph: Eligibilitate
    - listitem:
      - button "PFA — Blocat" [disabled]:
        - paragraph: PFA
    - listitem:
      - button "Fiscal, bancă & semnături — Blocat" [disabled]:
        - paragraph: Fiscal, bancă & semnături
    - listitem:
      - button "Autorizație transport — Blocat" [disabled]:
        - paragraph: Autorizație transport
    - listitem:
      - button "Uber & Bolt — Blocat" [disabled]:
        - paragraph: Uber & Bolt
    - listitem:
      - button "Vehicul, copie conformă & ecusoane — Blocat" [disabled]:
        - paragraph: Vehicul, copie conformă & ecusoane
  - paragraph: Ai nevoie de ajutor?
  - paragraph: Spune-ne ce document nu găsești.
...
- complementary "Progresul pasului curent":
