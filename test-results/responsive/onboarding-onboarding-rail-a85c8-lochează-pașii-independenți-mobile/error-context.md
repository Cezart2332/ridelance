...
Call log:
  ...
  - waiting for getByRole('button', { name: /Fiscal, bancă & semnături/ }).first()
    34 × locator resolved to <button disabled tabindex="-1" type="button" aria-label="Fiscal, bancă & semnături — Blocat" class="MuiButtonBase-root Mui-disabled css-t9pyze-MuiButtonBase-root">…</button>
