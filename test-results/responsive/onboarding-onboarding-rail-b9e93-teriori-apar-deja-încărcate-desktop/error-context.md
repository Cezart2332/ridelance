...
- Name: onboarding.spec.ts >> onboarding rail >> documentele din pașii anteriori apar deja încărcate
- Location: tests/responsive/onboarding.spec.ts:223:3
...
Locator: getByText('certificat.pdf')
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByText('certificat.pdf')
