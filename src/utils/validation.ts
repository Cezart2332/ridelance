/**
 * Validates a Romanian CUI (CIF)
 * Ported from the provided algorithm
 */
export function validateRomanianCIF(v: string | null | undefined): boolean | string {
  if (typeof v !== 'string' || !v) {
    return 'Nu este un șir de caractere valid!';
  }
