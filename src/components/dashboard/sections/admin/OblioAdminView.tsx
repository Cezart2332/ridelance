...
export function OblioAdminView() {
  const [view, tabs] = usePageTabs({ paramName: 'view', tabs: [
    { value: 'facturi', label: 'Facturi emise' }, { value: 'conexiune', label: 'Conexiune și verificare' },
  ] })
      ...
      >
        ...
        >
          <Stack direction="row" sx={{ alignItems: 'center', justifyContent: 'space-between', mb: 2 }}>
            <Typography sx={{ fontWeight: 650, color: TOKENS.ink }}>Status conexiune</Typography>
            <Button
              size="small"
        ...
        >
          <Typography sx={{ fontWeight: 650, color: TOKENS.ink, mb: 2 }}>
      ...
      >
        ...
        {invoicesLoading ? (
          ...
          <TableContainer sx={{ overflowX: 'auto' }}>
            <Table size="small">
              <TableHead>
                <TableRow sx={{ '& th': { fontWeight: 650, color: TOKENS.textMuted, fontSize: '0.75rem' } }}>
