...
import { Box, Button, Card, CardContent, Container, Stack, ToggleButton, ToggleButtonGroup, Typography } from '@mui/material'
...
/** Comutatorul de deasupra cardurilor. Aceeași formă pentru ambele alegeri. */
